    ...
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">
          {authType === 'login' ? 'Войдите в аккаунт' : 'Создайте аккаунт'}
        </h2>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="focus-visible:outline-primary flex w-full cursor-pointer justify-center rounded-md bg-black px-3 py-1.5 text-sm/6 font-semibold text-white transition-all duration-100 hover:shadow-xl focus-visible:outline-2 focus-visible:outline-offset-2"
            >
              {loading
                ? 'Загрузка...'
                : authType === 'login'
